...
introduced, how they related to other changes, and who made those changes.  If
...
\emph{Continuous integration (CI)} is the idea that software should be tested
...
testing are shown to code reviewers in the GitHub interface.  The \Cyclus
project currently uses the CircleCI service for continuous integration.
