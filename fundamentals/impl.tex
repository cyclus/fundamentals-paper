...
Facility & Reactor$^*$ & This facility has capabilities of BatchReactor (above), and requests any number of input fuel types and transmutes them to static compositions upon discharge.\\
...
1.3 are marked with $^*$. Facilities deprecated in version 1.3 are marked with 
$^{**}$.}
\label{tab:cycamore}
\end{table}
...
Each of these on its own is a valuable addition to \gls{QA} but it cannot be the
