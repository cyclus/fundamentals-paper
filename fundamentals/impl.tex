...
implementation of the region-institution-facility heirarchy. 
Next, the discrete treatment of objects is discussed in terms of both
resources and materials and time via the \TODO{DRE}.
Support for users and developers via the Cycamore library of
agents \TODO{archetypes?} and the experimental toolkit are also presented.
