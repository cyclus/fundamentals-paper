...
some common purpose. For example, a reactor may request UOX and MOX fuel
...
bids. For example, an enriched UOX supplier may supply both a natural Uranium
...
Trades are initiated by the \Cyclus kernel after a solution to the \gls{DRE} is
