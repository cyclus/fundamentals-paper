...
used run over $10^4$ jobs, or (\TODO{compute time}) total computer hours, using
...
any archetype can have access to \Cyclus' agent deployment mechanism.  It straightforward
...
provides a basic querying \gls{API}, including the atomic and mass fractions of
