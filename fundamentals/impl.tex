...
logic. To acheive this, agents are developed using the \Cyclus framework \gls{API}, a set of functions and protocols
which assist in agent development and specify how they should be defined. 
...
\TODO{Matt Gidden, please fill in}
