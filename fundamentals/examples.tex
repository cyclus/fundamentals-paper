...
\cite{djokic_application_2015,scopatz_non-judgemental_2015,gidden_once-through_2012} . 
The current examples are not the limit of \Cyclus' capabilities, which are extended with each new
