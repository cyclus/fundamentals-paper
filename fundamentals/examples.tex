...
\textbf{Name} & \textbf{Description} & \textbf{Citation} \\
\hline
Brite-lite & A physics-based reactor archetype and fuel fabrication archetype & \cite{flanagan_bright-lite_2014} \\
...
because material is tracked as discrete objects, single-pass mixed-oxide (MOX) 
recycle is
easy to implement.  The simulation initially included one provider of fresh
uranium oxide (UOX) fuel, one recycled fuel fabrication facility, one reactor, one separations
