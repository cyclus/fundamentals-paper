...
advance in this community-driven development paradigm. Additionally, simulation
...
archetypes by providing physics-based reactors, separations logic, fuel
fabrication processing, storage facilities, and expanded institutional paradigms.
...
fuel with a higher preference then new \gls{UOX} fuel. For the once through case,
...
provided by the material routing logic within the \Cyclus framework and provide
