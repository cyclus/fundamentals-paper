...
\cite{flicker_evaluation_2014}. With few exceptions (e.g.
\cite{poinssot_assessment_2014}), these metrics are derived from mass balances
calculated by a fuel cycle simulator.
