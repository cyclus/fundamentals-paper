...
simulators have not incorporated modern insights into simulation science and 
...
collaboration.  The \Cyclus project then improved upon the \gls{GENIUSv2} 
...
deployment and interaction logic of entities in the simulation. The archetypes represent 
individual types of facilities and capture their unique physics.  Accordingly, specialists
...
facility entities or materials.  As a result, detailed performance 
...
One such example is the use case that seeks to capture system vulnerability to nefarious 
