...
modeling platforms. To date, current tools are often rigid rather than
...
\cite{flicker_evaluation_2014}. With few exceptions (e.g. water pollution or 
land use as in \cite{poinssot_assessment_2014}), these metrics are derived from 
mass balances calculated by a fuel cycle simulator.
