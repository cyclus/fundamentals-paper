...
modeling platforms. To date, current tools are typically privately distributed
rather than open source and most acheive only fleet-level resolution of
facilities and materials rather than discrete resolution of those agents and
objects. Both choices present challenges to modeling fidelity, generality,
efficiency, robustness, and scientific transparency.
